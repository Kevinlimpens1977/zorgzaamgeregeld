                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto space-y-12">
                        ...
                        <div className="card bg-white p-8">
                            <h3 className="text-3xl font-serif font-medium text-title mb-4">
                        ...
                        {/* Advies Kaart */}
                        <div className="bg-surface/30 p-10 rounded-xl text-center">
                            <h3 className="text-3xl font-serif text-title mb-4">
                            ...
                            <div className="flex flex-col md:flex-row justify-center items-center gap-6 text-lg font-medium text-text">
                                <a href="tel:0612345678" className="flex items-center hover:text-gold transition-colors">
                                    <Phone size={24} className="mr-2" />
                                    06 12 34 56 78
                                </a>
                                <a href="mailto:info@zorgzaamgeregeld.nl" className="flex items-center hover:text-gold transition-colors">
